...
768d 모델로 정답 vs near-miss 코사인 분리를 직접 재봐도 동률(C3: 0.527/0.523)·역전(A4: 0.550/**0.626**) — **모델 크기로 풀 문제가 아니다.**
...
**슬랙봇 기동** — `.env`에 `SLACK_BOT_TOKEN`(xoxb)·`SLACK_APP_TOKEN`(xapp) 설정 후:
